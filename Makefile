...
cabbage: main.c
	gcc main.c -o cabbage $(GCC_FLAG) -lm -lreadline -lcurl -lglfw
...
cabbage.exe: main.c cabbage.ico.o cabbagew.exe
	gcc main.c cabbage.ico.o -o cabbage $(GCC_FLAG) -lws2_32 -lwinmm -lwininet -lglfw3 -lgdi32 -static
cabbagew.exe: main.c cabbage.ico.o
	gcc main.c cabbage.ico.o -o cabbagew $(GCC_FLAG) -mwindows  -lws2_32 -lwinmm -lwininet -lglfw3 -lgdi32 -static
